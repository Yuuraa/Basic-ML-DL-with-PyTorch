...
# From UNet
# Convolution + Batch Norm + ReLU (2D)
...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.conv4_1 = CBR2d(in_channels=256, out_channels=512)
        self.conv4_2 = CBR2d(in_channels=512, out_channels=512)
        ...
        self.out_layer = CBR2d(in_channels=64, out_channels=1, kernel_size=1, stride=1, padding=0)
        # self.out_layer = CBR2d(in_channels=64, out_channels=2, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        cat4 = torch.cat((enc4_2, unpool4), dim=1) # MY
